...
pub struct Config {
    ...
    pub mcp_searches_per_minute: NonZeroU32,
...
impl Config {
    pub fn from_env() -> Result<Self, ConfigError> {
        Ok(Self {
            ...
            searches_per_minute: parsed(
                "SEARCHES_PER_MINUTE",
                &limits::SEARCHES_PER_MINUTE.to_string(),
            )?,
            mcp_searches_per_minute: parsed(
                "MCP_SEARCHES_PER_MINUTE",
                &limits::SEARCHES_PER_MINUTE.to_string(),
            )?,
