...
export const es: Messages = {
  ...
  tool: {
    ...
    stars: "Estrellas",
    starChart: "Estrellas en {days} días",
    starChartDay: "{day}: {n} estrellas",
    starChartSummary: "{from} estrellas el {start}, {to} el {end}",
    forks: "Forks",
  ...
  changes: {
    ...
    description:
      "La lista fechada de lo que ha cambiado en el catálogo awesome-alternatives: cambios de licencia, repositorios renombrados o archivados, nuevas releases, herramientas que entran o salen.",
    eyebrow: "Cambios",
    heading: "Qué ha cambiado",
    lede: "Cada refresh compara el catálogo con el anterior y guarda lo que cambió. El número de estrellas nunca cuenta como un cambio.",
    feedLink: "Feed RSS de todos los cambios",
    feedNote: "Cada página de herramienta y cada categoría tiene también su propio feed.",
    empty: "Todavía no ha cambiado nada.",
    commit: "commit",
    commitsOfDay: "commits del día",
    noLicense: "ninguna",
    followTool: "Cambios de {name} (RSS)",
    followCategory: "Cambios en esta categoría (RSS)",
    feedTitle: "awesome-alternatives: qué ha cambiado",
    feedDescription: "Cambios de licencia, repositorios renombrados o archivados, nuevas releases y nuevas herramientas en el catálogo awesome-alternatives.",
    toolFeedTitle: "{name}: qué ha cambiado",
    toolFeedDescription: "Los cambios de licencia, nombre, archivo y release de {name}, tal como los vio el catálogo awesome-alternatives.",
    categoryFeedTitle: "{name}: qué ha cambiado",
    categoryFeedDescription: "Qué ha cambiado en la categoría {name} del catálogo awesome-alternatives.",
    addedGroup: { one: "{n} herramienta añadida", other: "{n} herramientas añadidas" },
    addedMore: { one: "y {n} más", other: "y {n} más" },
    events: {
      added: "{name} entró en el catálogo.",
      removed: "{name} salió del catálogo.",
      renamed: "{name} se mudó de {from} a {to}.",
      "license-changed": "{name} cambió de licencia, de {from} a {to}.",
      archived: "{name} fue archivado.",
      unarchived: "{name} ya no está archivado.",
      inactive: "{name} no ha recibido ningún push en {days} días.",
      reactivated: "{name} vuelve a estar activo.",
      released: "{name} publicó {to}.",
    },
  },
