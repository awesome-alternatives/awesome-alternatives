...
export const pages: Pages = {
  about: {
    ...
    agents: {
      heading: "Depuis un agent IA",
      body: "Le catalogue est aussi un serveur Model Context Protocol (MCP) à l'adresse {url}, en Streamable HTTP, sans clé ni compte. Un agent peut y trouver des alternatives à un outil ou à un produit, lister les outils par catégorie, langage ou licence, et lire les informations d'un outil. Son outil de recherche lit les requêtes avec les mots-clés et le modèle de ce serveur uniquement, jamais avec Jev, et il est limité par adresse ; les autres outils ne le sont pas.",
      setup: "Pour l'ajouter à Claude Code :",
    },
    licences: {
      heading: "Licences",
  ...
  contact: {
    title: "Contact",
    description: "Comment joindre les personnes derrière awesome-alternatives.com, et où chaque demande avance le plus vite.",
    eyebrow: "Contact",
    heading: "Nous contacter",
    lede: "Le catalogue est tenu en public sur GitHub, la plupart des demandes y avancent donc plus vite. Pour tout le reste, utilisez le formulaire en bas de cette page ou écrivez à",
    catalog: {
      heading: "Proposer un outil ou corriger une fiche",
      before: "Ouvrez une",
      pullRequest: "pull request",
      between: " ou ",
      suggest: "proposez un outil",
      after: " dans une issue. Le ",
      guide: "guide de contribution",
      end: " explique ce qu'une fiche doit contenir.",
    },
    maintainer: {
      heading: "Vous maintenez un outil listé",
      before: "Votre fiche peut être marquée comme",
      verifiedLink: "vérifiée par ses mainteneurs",
      after: ". Pour la corriger ou la retirer, ",
      issueLink: "ouvrez une issue",
    },
    security: {
      heading: "Signaler une faille de sécurité",
      before: "N'ouvrez pas d'issue publique. Suivez la",
      policyLink: "politique de sécurité",
      after: " pour la signaler en privé.",
    },
    privacy: {
      heading: "Données personnelles",
      before: "Ce que ce site conserve est décrit dans la",
      privacyLink: "politique de confidentialité",
      after: ". Pour exercer vos droits, écrivez à",
    },
    other: {
      heading: "Pour tout le reste",
      before: "Envoyez un message ici, ou écrivez à",
      after: ". Chaque message est lu par une personne, qui répond par e-mail.",
    },
    form: {
      ...
      sentBody: "Une personne vous répondra à l'adresse indiquée. Une copie arrive dans votre boîte de réception.",
      reference: "Référence",
