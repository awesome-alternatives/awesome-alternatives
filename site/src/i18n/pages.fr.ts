...
export const pages: Pages = {
  ...
  legalNotice: {
    ...
    content: {
      ...
      codeLink: "MIT",
      licenceAfter:
        ". Les chiffres des dépôts (étoiles, releases, licences, descriptions) proviennent de l'API publique GitHub. Les noms de projets et les marques appartiennent à leurs titulaires.",
