...
export const pages: Pages = {
  ...
  contact: {
    ...
    lede: "Le catalogue est tenu en public sur GitHub, la plupart des demandes y avancent donc plus vite. Pour tout le reste, écrivez à",
    catalog: {
    ...
    other: {
      ...
      before: "Écrivez à",
      after: ". Chaque message est lu par une personne.",
    },
  },
};
