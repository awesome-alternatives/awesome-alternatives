...
export const pages: Pages = {
  ...
  contact: {
    ...
    eyebrow: "Contacto",
    heading: "Contacto",
    lede: "El catálogo se mantiene en abierto en GitHub, así que la mayoría de las peticiones avanzan más rápido allí. Para todo lo demás, escribe a",
    catalog: {
    ...
    other: {
      ...
      before: "Escribe a",
      after: ". Una persona lee cada mensaje.",
    },
  },
};
