...
export const pages: Pages = {
  ...
  contact: {
    title: "Contacto",
    description: "Cómo contactar con las personas detrás de awesome-alternatives.com, y dónde avanza más rápido cada tipo de petición.",
    eyebrow: "Contacto",
    heading: "Contacto",
    lede: "El catálogo se mantiene en abierto en GitHub, así que la mayoría de las peticiones avanzan más rápido allí. Para todo lo demás, usa el formulario al final de esta página o escribe a",
    catalog: {
      heading: "Proponer una herramienta o corregir una ficha",
      before: "Abre un",
      pullRequest: "pull request",
      between: " o ",
      suggest: "propón una herramienta",
      after: " en una issue. La ",
      guide: "guía de contribución",
      end: " explica qué necesita una ficha.",
    },
    maintainer: {
      heading: "Mantienes una herramienta listada",
      before: "Tu ficha puede marcarse como",
      verifiedLink: "verificada por sus mantenedores",
      after: ". Para corregirla o retirarla, ",
      issueLink: "abre una issue",
    },
    security: {
      heading: "Informar de un fallo de seguridad",
      before: "No abras una issue pública. Sigue la",
      policyLink: "política de seguridad",
      after: " para informar en privado.",
    },
    privacy: {
      heading: "Datos personales",
      before: "Lo que guarda este sitio se describe en la",
      privacyLink: "política de privacidad",
      after: ". Para ejercer tus derechos, escribe a",
    },
    other: {
      heading: "Todo lo demás",
      before: "Envía un mensaje aquí, o escribe a",
      after: ". Una persona lee cada mensaje y responde por correo.",
    },
    form: {
      ...
      kinds: {
        ...
        security: "Un fallo de seguridad",
      ...
      sentBody: "Una persona te responderá en la dirección que indicaste. Recibirás una copia en tu bandeja de entrada, en inglés.",
