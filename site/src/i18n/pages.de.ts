...
export const pages: Pages = {
  ...
  contact: {
    ...
    eyebrow: "Kontakt",
    heading: "Kontakt",
    lede: "Der Katalog wird offen auf GitHub gepflegt, die meisten Anliegen kommen dort also schneller voran. Für alles andere schreib an",
    catalog: {
    ...
    other: {
      ...
      before: "Schreib an",
      after: ". Jede Nachricht liest ein Mensch.",
    },
  },
};
