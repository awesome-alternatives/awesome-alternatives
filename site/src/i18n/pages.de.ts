...
export const pages: Pages = {
  ...
  contact: {
    title: "Kontakt",
    description: "Wie du die Menschen hinter awesome-alternatives.com erreichst, und wo jede Art von Anliegen am schnellsten vorankommt.",
    eyebrow: "Kontakt",
    heading: "Kontakt",
    lede: "Der Katalog wird offen auf GitHub gepflegt, die meisten Anliegen kommen dort also schneller voran. Für alles andere nutz das Formular unten auf dieser Seite oder schreib an",
    catalog: {
      heading: "Ein Tool vorschlagen oder einen Eintrag korrigieren",
      before: "Öffne einen",
      pullRequest: "Pull Request",
      between: " oder ",
      suggest: "schlag in einem Issue ein Tool vor",
      after: ". Der ",
      guide: "Leitfaden für Beiträge",
      end: " erklärt, was ein Eintrag braucht.",
    },
    maintainer: {
      heading: "Du pflegst ein gelistetes Tool",
      before: "Dein Eintrag kann als",
      verifiedLink: "von seinen Maintainern bestätigt",
      after: " markiert werden. Um ihn zu korrigieren oder zu entfernen, ",
      issueLink: "öffne ein Issue",
    },
    security: {
      heading: "Eine Sicherheitslücke melden",
      before: "Bitte öffne kein öffentliches Issue. Folge der",
      policyLink: "Sicherheitsrichtlinie",
      after: ", um sie vertraulich zu melden.",
    },
    privacy: {
      heading: "Personenbezogene Daten",
      before: "Was diese Seite speichert, steht in der",
      privacyLink: "Datenschutzerklärung",
      after: ". Um deine Rechte auszuüben, schreib an",
    },
    other: {
      heading: "Alles andere",
      before: "Schick hier eine Nachricht, oder schreib an",
      after: ". Jede Nachricht liest ein Mensch und antwortet per E-Mail.",
    },
    form: {
      kind: "Worum geht es?",
      kinds: {
        ...
        security: "Eine Sicherheitslücke",
      ...
      subject: "Betreff",
      message: "Nachricht",
      honeypot: "Lass dieses Feld leer",
      submit: "Senden",
      sentTitle: "Nachricht gesendet",
      sentBody: "Ein Mensch antwortet an die angegebene Adresse. Eine Kopie auf Englisch ist auf dem Weg in dein Postfach.",
      reference: "Referenz",
