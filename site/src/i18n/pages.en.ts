export const pages = {
  ...
  contact: {
    title: "Contact",
    description: "How to reach the people behind awesome-alternatives.com, and where each kind of request goes fastest.",
    eyebrow: "Contact",
    heading: "Get in touch",
    lede: "The catalog is maintained in the open on GitHub, so most requests go faster there. For anything else, use the form at the bottom of this page or write to",
    catalog: {
      heading: "Suggest a tool or fix an entry",
      before: "Open a",
      pullRequest: "pull request",
      between: " or ",
      suggest: "suggest a tool",
      after: " in an issue. The ",
      guide: "contribution guide",
      end: " explains what an entry needs.",
    },
    maintainer: {
      heading: "You maintain a listed tool",
      before: "You can have your entry marked as",
      verifiedLink: "verified by its maintainers",
      after: ". To correct or remove it, ",
      issueLink: "open an issue",
    },
    security: {
      heading: "Report a security issue",
      before: "Please do not open a public issue. Follow the",
      policyLink: "security policy",
      after: " to report it privately.",
    },
    privacy: {
      heading: "Personal data",
      before: "What this site keeps is described in the",
      privacyLink: "privacy policy",
      after: ". To exercise your rights, write to",
    },
    other: {
      heading: "Anything else",
      before: "Send a message here, or write to",
      after: ". A person reads every message and answers by email.",
    },
    form: {
      ...
      sentBody: "A person will answer at the address you gave. A copy is on its way to your inbox.",
      reference: "Reference",
