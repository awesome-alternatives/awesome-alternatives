...
export const de: Messages = {
  ...
  owner: {
    ...
    kindLede: {
      organization: "Repositories von {name}, einer Organisation auf GitHub.",
      user: "Repositories von {name}, einer Person auf GitHub.",
    },
  ...
  changes: {
    ...
    description:
      "Die datierte Liste der Änderungen im awesome-alternatives-Katalog: Lizenzwechsel, umbenannte und archivierte Repositories, neue Releases, Tools, die dazukommen oder gehen.",
    eyebrow: "Änderungen",
    heading: "Was sich geändert hat",
    lede: "Jeder Refresh vergleicht den Katalog mit dem vorherigen und behält, was sich geändert hat. Sterne zählen nie als Änderung.",
    feedLink: "RSS-Feed aller Änderungen",
    feedNote: "Jede Tool-Seite und jede Kategorie hat auch einen eigenen Feed.",
    empty: "Noch hat sich nichts geändert.",
    commit: "Commit",
    commitsOfDay: "Commits des Tages",
    noLicense: "keiner",
    followTool: "Änderungen an {name} (RSS)",
    followCategory: "Änderungen in dieser Kategorie (RSS)",
    feedTitle: "awesome-alternatives: was sich geändert hat",
    feedDescription: "Lizenzwechsel, umbenannte und archivierte Repositories, neue Releases und neue Tools im awesome-alternatives-Katalog.",
    toolFeedTitle: "{name}: was sich geändert hat",
    toolFeedDescription: "Änderungen an Lizenz, Name, Archivstatus und Releases von {name}, so wie der awesome-alternatives-Katalog sie gesehen hat.",
    categoryFeedTitle: "{name}: was sich geändert hat",
    categoryFeedDescription: "Was sich in der Kategorie {name} des awesome-alternatives-Katalogs geändert hat.",
    addedGroup: { one: "{n} Tool hinzugefügt", other: "{n} Tools hinzugefügt" },
    addedMore: { one: "und {n} weiteres", other: "und {n} weitere" },
    events: {
      added: "{name} ist in den Katalog aufgenommen worden.",
      removed: "{name} hat den Katalog verlassen.",
      renamed: "{name} ist von {from} nach {to} umgezogen.",
      "license-changed": "{name} hat die Lizenz von {from} auf {to} geändert.",
      archived: "{name} wurde archiviert.",
      unarchived: "{name} ist nicht mehr archiviert.",
      inactive: "{name} hat seit {days} Tagen keinen Push erhalten.",
      reactivated: "{name} ist wieder aktiv.",
      released: "{name} hat {to} veröffentlicht.",
    },
  },
  ...
  vitality: {
    created: "Erstellt",
    age: { one: "{year}, vor {n} Jahr", other: "{year}, vor {n} Jahren" },
    ageNew: "{year}, vor weniger als einem Jahr",
    contributors: "Aktive Mitwirkende",
    contributorsCount: {
      one: "{n} Commit-Autor auf dem Standard-Branch in den letzten 90 Tagen",
      other: "{n} Commit-Autoren auf dem Standard-Branch in den letzten 90 Tagen",
    },
    contributorsCapped: "{n}+ Commit-Autoren auf dem Standard-Branch in den letzten 90 Tagen",
    wholeRepository: "Gezählt über das ganze Repository, nicht nur {path}.",
