...
export const fr: Messages = {
  ...
  tool: {
    ...
    stars: "Étoiles",
    starChart: "Étoiles sur {days} jours",
    starChartDay: "{day} : {n} étoiles",
    starChartSummary: "{from} étoiles le {start}, {to} le {end}",
    forks: "Forks",
  ...
  changes: {
    ...
    description:
      "La liste datée de ce qui a changé dans le catalogue awesome-alternatives : changements de licence, dépôts renommés ou archivés, nouvelles releases, outils ajoutés ou retirés.",
    eyebrow: "Changements",
    heading: "Ce qui a changé",
    lede: "Chaque refresh compare le catalogue au précédent et garde ce qui a changé. Le nombre d'étoiles ne compte jamais comme un changement.",
    feedLink: "Flux RSS de tous les changements",
    feedNote: "Chaque page d'outil et chaque catégorie a aussi son propre flux.",
    empty: "Rien n'a encore changé.",
    commit: "commit",
    commitsOfDay: "commits du jour",
    noLicense: "aucune",
    followTool: "Changements de {name} (RSS)",
    followCategory: "Changements dans cette catégorie (RSS)",
    feedTitle: "awesome-alternatives : ce qui a changé",
    feedDescription: "Changements de licence, dépôts renommés ou archivés, nouvelles releases et nouveaux outils dans le catalogue awesome-alternatives.",
    toolFeedTitle: "{name} : ce qui a changé",
    toolFeedDescription: "Les changements de licence, de nom, d'archivage et de release de {name}, tels que le catalogue awesome-alternatives les a vus.",
    categoryFeedTitle: "{name} : ce qui a changé",
    categoryFeedDescription: "Ce qui a changé dans la catégorie {name} du catalogue awesome-alternatives.",
    addedGroup: { one: "{n} outil ajouté", other: "{n} outils ajoutés" },
    addedMore: { one: "et {n} autre", other: "et {n} autres" },
    events: {
      added: "{name} a rejoint le catalogue.",
      removed: "{name} a quitté le catalogue.",
      renamed: "{name} a déménagé de {from} vers {to}.",
      "license-changed": "{name} est passé de la licence {from} à {to}.",
      archived: "{name} a été archivé.",
      unarchived: "{name} n'est plus archivé.",
      inactive: "{name} n'a reçu aucun push depuis {days} jours.",
      reactivated: "{name} est de nouveau actif.",
      released: "{name} a publié {to}.",
    },
  },
  ...
  vitality: {
    created: "Création",
    age: { one: "{year}, il y a {n} an", other: "{year}, il y a {n} ans" },
    ageNew: "{year}, il y a moins d'un an",
    contributors: "Contributeurs actifs",
    contributorsCount: {
      one: "{n} auteur de commits sur la branche par défaut ces 90 derniers jours",
      other: "{n} auteurs de commits sur la branche par défaut ces 90 derniers jours",
    },
    contributorsCapped: "{n}+ auteurs de commits sur la branche par défaut ces 90 derniers jours",
    wholeRepository: "Compté sur tout le dépôt, pas seulement {path}.",
